...
class Passation_model extends CI_Model
{
    ...
    {
       $this->db->select('BaseTbl.passationId, User.userId , User.nom, User.prenom  , User.name , Club.clubID , Club.name clubName , RoleAct.role act ,  RoleVol.role vol , RoleVol.roleId , User.cellule , BaseTbl.cellule celluleVol ');
