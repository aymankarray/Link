...
<body><nav id="shoppingbag" class="mm-menu mm-offcanvas mm-right" aria-hidden="true"><div class="mm-panels"><div class="mm-panel mm-hasnavbar mm-opened" id="mm-13"><div class="mm-navbar"><a class="mm-title">General Setting</a></div>
	...
	<div class="responsive-header">
		<div class="mh-head first mm-sticky mh-btns-left mh-btns-right mh-sticky" style="">
			...
			<span class="mh-text">
				<a href="newsfeed.html" title=""><img src="<?php echo base_url()?>assets/images/logo2.svg" width="45%" alt=""></a>
			</span>
	...
	<div class="topbar stick" style="">
		<div class="logo">
			<a title="" href="newsfeed.html"><img src="<?php echo base_url()?>assets/images/logo2.svg" width="45%" alt=""></a>
		</div>
		<div class="top-area">
			<div class="main-menu">
				<span>
			...
			<ul class="setting-area">
				...
				<li>
					...
					<div class="dropdowns ps-container ps-theme-default ps-active-y" data-ps-id="46ec61a0-d87b-7ce6-e5c0-7c5bdc032c65">
				...
				<li><a href="#" title="Languages" data-ripple=""><i class="fa fa-globe"></i><em>EN</em></a>
					<div class="dropdowns languages ps-container ps-theme-default" data-ps-id="9c470892-d412-7694-6d99-accab882c914">
