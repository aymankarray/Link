            ...
            <div class="row merged20" id="page-contents">
                ...
                <aside class="sidebar static left">
                  <div class="widget">
                    ...
                    <ul class="fav-community">
                      ...
                      <li><i class="fa fa-map-marker"></i>Ocean_motel@yourmail.com</li>
                    </ul>
                  </div><!-- Page Community-->  
                  <div class="widget">
                    <h4 class="widget-title">Twitter feed</h4>
                    <ul class="twiter-feed ps-container ps-theme-default ps-active-y" data-ps-id="eb7cf6f6-a5f6-4ea3-63ec-487e7561d2a9">
                      <li>
                    ...
                    <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 395px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 336px;"></div></div></ul>
                  </div><!-- twitter feed-->
              ...
              <div class="col-lg-6">
                ...
                <div class="central-meta">
                  ...
                  <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-513px, 0px, 0px); transition: all 0s ease 0s; width: 1795.5px;"><div class="owl-item cloned" style="width: 118.25px; margin-right: 10px;"><li>
                    ...
                    </li></div><div class="owl-item cloned" style="width: 118.25px; margin-right: 10px;"><li>
                    ...
                    </li></div><div class="owl-item active" style="width: 118.25px; margin-right: 10px;"><li>
                    ...
                    </li></div><div class="owl-item" style="width: 118.25px; margin-right: 10px;"><li>
                      <img src="images/resources/recent5.jpg" alt="">
                      <div class="sugtd-frnd-meta">
                        <a href="#" title="">Sophia</a>
                        <span>1 mutual friend</span>
