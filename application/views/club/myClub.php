                                          ...
                                          <div class="tab-pane fade" id="work" role="tabpanel">
                                             ...
                                             <ul class="suggestions-lists m-0 p-0">
                                                ...
                                                <li class="d-flex mb-4 align-items-center">
                                                   ...
                                                   <div class="media-support-info ml-3">
                                                      <h6><small class="text-primary mr-1 "> <?php echo $key->projectId  ?></small> <b class=" mr-1"> <?php echo $key->titre  ?></b><small class="text-primary mr-1" >  <?php echo $key->startDate  ?>   </small></h6>
                                                   </div>
