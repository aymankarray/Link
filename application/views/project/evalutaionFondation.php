    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="kt-subheader__toolbar">
                            ...
                            <a href="/metronic/preview/demo1/.html" class="">
                                                ...
                                                <a href="/metronic/preview/demo1/custom/apps/user/add-user.html" class="btn btn-label-brand btn-bold">
        ...
        <div class="kt-widget kt-widget--user-profile-3">
            <div class="kt-widget__top">
                <div class="kt-widget__media kt-hidden-">
                    <img src="/metronic/themes/metronic/theme/default/demo1/dist/assets/media/project-logos/3.png" alt="image">
                </div>
                        ...
                        <div class="kt-section__content kt-section__content--solid">
                            <div class="kt-media-group">
                                ...
                                <a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" data-placement="top" title="" data-original-title="Selina Cranson">
                                    <img src="/metronic/themes/metronic/theme/default/demo1/dist/assets/media/users/100_2.jpg" alt="image">
                                </a>
                                <a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" data-placement="top" title="" data-original-title="Luke Walls">
                                    <img src="/metronic/themes/metronic/theme/default/demo1/dist/assets/media/users/100_13.jpg" alt="image">
                                </a>
                                <a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" data-placement="top" title="" data-original-title="Micheal York">
                                    <img src="/metronic/themes/metronic/theme/default/demo1/dist/assets/media/users/100_4.jpg" alt="image">
                                </a>
                                <a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" data-placement="top" title="" data-original-title="Micheal York">
                                    <span>+3</span>
                                </a>
	...
	<div class="kt-portlet__body kt-portlet__body--fluid">
		<div class="kt-widget12">
			...
			<div class="kt-widget12__chart" style="height:250px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
				<canvas id="kt_chart_order_statistics" style="display: block; height: 250px; width: 626px;" width="500" height="200" class="chartjs-render-monitor"></canvas>
			</div>
		</div>		 
	</div>
</div>
