            ...
            <div class="card-body">
                ...
                <table  class="table table-dark" >
                                        ...
                                        <?php  if(!empty($RateMember)){ foreach ($RateMember as $membre ) { ?>
                                          <tr>
                                            <td rowspan="2" > <img src="https://www.tunivisions.link/uploads/avatar/<?php echo $membre->avatar ?>" class="alligator-turtle  mr-3" alt="user"> </td>
                                            <td> <small><small><?php $c=-1 ; $c++ ;  if ($c== 0) { ?>
